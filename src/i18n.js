...
(function () {
    const translations = {
        en: {
            ...
            settings_webdav_url_tip: "Tip for Nextcloud: URL is https://your-cloud.com/remote.php/dav/files/USERNAME/ (auto-completed if only domain is entered).",
        ...
        de: {
            ...
            settings_webdav_url_tip: "Tipp für Nextcloud: WebDAV-URL lautet https://ihre-cloud.de/remote.php/dav/files/BENUTZERNAME/ (wird bei Eingabe der Domain automatisch ergänzt).",
        ...
        es: {
            ...
            settings_webdav_url_tip: "Consejo para Nextcloud: La URL es https://su-nube.com/remote.php/dav/files/USUARIO/ (se completa automáticamente si solo se introduce el dominio).",
        ...
        fr: {
            ...
            settings_webdav_url_tip: "Conseil pour Nextcloud : L'URL est https://votre-cloud.com/remote.php/dav/files/UTILISATEUR/ (complétée automatiquement si seul le domaine est saisi).",
