...
(function () {
    const translations = {
        en: {
            ...
            tooltip_resize_width: "Drag to resize width",
            tooltip_toggle_fit: "Toggle Window Fit / Maximize",
            ...
            settings_tab_about: "ℹ️ About & Impressum",
            settings_about_title: "About PureTidings Desktop",
            settings_about_version_label: "Version",
            settings_about_developer: "Developer & Impressum",
            settings_impressum_link: "Impressum / Legal Notice",
            settings_website_link: "Official Website",
            settings_about_privacy_title: "100% Local-First & Zero Server Costs",
            settings_about_privacy_desc: "PureTidings operates entirely on your local machine. There are no cloud relay servers, no telemetry trackers, and no monthly subscriptions. All feeds, inboxes, and your Gemini API key remain strictly on your hard drive.",
            ...
            settings_webdav_url_tip: "Nextcloud: Simply enter your Nextcloud server address (e.g. https://cloud.example.com), username, and password.",
            ...
            settings_webdav_pull_btn: "📥 Force Pull from Cloud",
            settings_webdav_pull_confirm: "Download and adopt all feeds and data from the cloud? This will overwrite local feeds with the cloud state.",
            ...
            settings_satellite_step1: "Open chrome://extensions/ in your browser",
        ...
        de: {
            ...
            tooltip_resize_width: "Ziehen, um die Breite anzupassen",
            tooltip_toggle_fit: "Fenstergröße anpassen / Maximieren",
            ...
            tooltip_move_up: "Nach oben verschieben",
            tooltip_move_down: "Nach unten verschieben",
            ...
            settings_tab_backup: "Backup & OPML",
            settings_tab_about: "ℹ️ Über & Impressum",
            settings_about_title: "Über PureTidings Desktop",
            settings_about_version_label: "Version",
            settings_about_developer: "Entwickler & Impressum",
            settings_impressum_link: "Impressum",
            settings_website_link: "Projekt-Webseite",
            settings_about_privacy_title: "100% Local-First & 0 € Serverkosten",
            settings_about_privacy_desc: "PureTidings arbeitet vollständig lokal auf Ihrem Rechner. Es gibt keine zentralen Cloud-Server, keine Telemetrie-Tracker und keine versteckten Abonnements. Alle Feeds, Zugangsdaten und Gemini API-Schlüssel verbleiben ausschließlich auf Ihrer Festplatte.",
            ...
            settings_webdav_url_tip: "Nextcloud: Geben Sie einfach Ihre Nextcloud-Adresse (z. B. https://cloud.ihre-domain.de), Benutzername und Passwort ein.",
            ...
            settings_webdav_pull_btn: "📥 Aus Cloud übernehmen",
            settings_webdav_pull_confirm: "Möchten Sie alle Feeds und Daten aus der Cloud laden? Dadurch werden lokale Feeds mit dem Cloud-Stand überschrieben.",
            ...
            settings_satellite_step1: "Öffne chrome://extensions/ in deinem Browser",
            settings_satellite_step2: "Schalte oben rechts den \"Entwicklermodus\" ein",
            settings_satellite_step3: "Klicke auf \"Entpackte Erweiterung laden\" und wähle den geöffneten Ordner",
        ...
        es: {
            ...
            tooltip_resize_width: "Arrastrar para cambiar el ancho",
            tooltip_toggle_fit: "Ajustar ventana / Maximizar",
            ...
            settings_tab_about: "ℹ️ Acerca de e Impressum",
            settings_about_title: "Acerca de PureTidings Desktop",
            settings_about_version_label: "Versión",
            settings_about_developer: "Desarrollador e Impressum",
            settings_impressum_link: "Aviso Legal / Impressum",
            settings_website_link: "Sitio Web Oficial",
            settings_about_privacy_title: "100% Local y Sin Costes de Servidor",
            settings_about_privacy_desc: "PureTidings funciona completamente en su máquina local. No hay servidores en la nube, ni rastreadores, ni suscripciones. Sus fuentes, correos y claves API permanecen en su disco.",
            ...
            settings_webdav_url_tip: "Nextcloud: Simplemente introduzca la dirección de su servidor Nextcloud (ej. https://cloud.ejemplo.com), usuario y contraseña.",
            ...
            settings_webdav_pull_btn: "📥 Traer de la nube",
            settings_webdav_pull_confirm: "¿Descargar y aplicar todos los feeds y datos de la nube? Esto sobrescribirá los feeds locales con el estado de la nube.",
            ...
            settings_satellite_step1: "Abre chrome://extensions/ en tu navegador",
            settings_satellite_step2: "Activa el \"Modo de desarrollador\" en la esquina superior derecha",
            settings_satellite_step3: "Haz clic en \"Cargar descomprimida\" y selecciona la carpeta abierta",
        ...
        fr: {
            ...
            tooltip_resize_width: "Glisser pour redimensionner la largeur",
            tooltip_toggle_fit: "Ajuster la fenêtre / Maximiser",
            ...
            settings_tab_about: "ℹ️ À propos & Mentions légales",
            settings_about_title: "À propos de PureTidings Desktop",
            settings_about_version_label: "Version",
            settings_about_developer: "Développeur et Mentions légales",
            settings_impressum_link: "Mentions légales / Impressum",
            settings_website_link: "Site Web officiel",
            settings_about_privacy_title: "100% Local & Sans Frais de Serveur",
            settings_about_privacy_desc: "PureTidings fonctionne entièrement sur votre appareil. Aucun serveur cloud intermédiaire, aucun suivi et aucun abonnement. Vos flux, e-mails et clés API restent sur votre disque.",
            ...
            settings_webdav_url_tip: "Nextcloud : Entrez simplement l'adresse de votre serveur Nextcloud (ex. https://cloud.exemple.com), nom d'utilisateur et mot de passe.",
            ...
            settings_webdav_pull_btn: "📥 Récupérer du Cloud",
            settings_webdav_pull_confirm: "Télécharger et appliquer tous les flux et données du cloud ? Cela écrasera les flux locaux avec l'état du cloud.",
            ...
            settings_satellite_step1: "Ouvrez chrome://extensions/ dans votre navigateur",
            settings_satellite_step2: "Activez le \"Mode développeur\" en haut à droite",
            settings_satellite_step3: "Cliquez sur \"Charger l'extension non empaquetée\" et sélectionnez le dossier ouvert",
